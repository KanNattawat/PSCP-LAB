...
def main():
    ...
    for _ in range(countable):
        ...
        if len(txt.split('"')) > len(txt.split("'")):
            ...
            dict_cat[txt.split("'")[1]] = txt.split("'")[3]
    count_of_cat, count_of_fox = lener(dict_cat, "Cat"), lener(dict_cat, "Fox")
    ...
    count_of_cat, count_of_fox = lener(cat_result, "Cat"), \
        lener(cat_result, "Fox")
    cat, fox = {}, {}
